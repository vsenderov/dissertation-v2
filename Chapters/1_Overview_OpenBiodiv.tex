...
In combination with the RDF4R package, the code-base is completed by one more R package, \cl{ropenbio} and the OpenBiodiv base package of scripts and documentation necessary to bootstrap the database. \cl{ropenbio} utilizes the RDF4R package to convert semi-structured XML to RDF. It contains the "mappings" necessary for that conversion. It is available under \url{https://github.com/pensoft/ropenbio}. The OpenBiodiv base pacjage coordinates the invocation of \url{ropenbio}, contains scripts for the automatic import of new resources, other housekeeping details, and extensive documentation. It is available under \url{https://github.com/pensoft/openbiodiv}. The usage of these packages to generate the OpenBiodiv-LOD is discussed in Chapter~\ref{chapter-lod}.
