...
\begin{enumerate}
\item \longfullcite{senderov_open_2016} (\ul{at least 3 unique citations})
\item \longfullcite{sarah_faulwetter_emodnet_2016}
\item \longfullcite{cardoso_species_2016} (\ul{at least 5 unique citations})
\item \longfullcite{senderov_online_2016} (\ul{at least 1 unique citation})
\item \longfullcite{penev_strategies_2017} (\ul{at least 6 unique citations})
\item \longfullcite{penev_arpha-biodiv:_2017} (\ul{at least 1 unique citations})
\item \longfullcite{arriaga-varela_review_2017} 
\item \longfullcite{senderov_openbiodiv-o:_2018} (\ul{at least 3 unique citations})
\end{enumerate}
\endgroup
