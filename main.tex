...
\supervisor{Prof. Lyubomir \textsc{Penev} and Prof. Kiril \textsc{Simov}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\university{\href{http://www.bas.bg}{Bulgarian Academy of Sciences}}
...
\department{\href{http://www.iict.bas.bg}{Institute for Information and Communication Technologies \\ Bulgarian Academy of Sciencess \\ Pensoft Publishers}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
...
\noindent\enquote{\itshape The semantic web is the future of the internet and always will be.}\bigbreak
...
\addchaptertocentry{Abbreviations}
...
\begin{software}{ll} % Include a list of abbreviations (a table of two columns)
\addchaptertocentry{Availability of data and software}
...
\href{https://github.com/vsenderov/openbiodiv}{github.com/pensoft/OpenBiodiv} & OpenBiodiv documentation\\
\href{https://github.com/pensoft/openbiodiv-o}{github.com/pensoft/openbiodiv-o} & OpenBiodiv ontology source code\\
\href{https://github.com/pensoft/rdf4r}{github.com/pensoft/openbiodiv-o} & R library for working with RDF\\
\href{https://github.com/pensoft/ropenbio}{github.com/pensoft/openbiodiv-o} & XML converters used with RDF4R\\
...
%\include{Chapters/2_ProblemDefinition}
\include{Chapters/1_Overview_OpenBiodiv}
\include{Chapters/2_Ontology}
\include{Chapters/3_LinkedOpenDataset}
\include{Chapters/4_RDF4R}
\include{Chapters/5_CaseStudy}
\include{Chapters/6_Webportal}
%\part{Conclusion}
