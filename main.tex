...
\usepackage[style=chicago-authordate,strict,backend=bibtex8,maxnames=99,%
...
\include{Chapters/7_RDF4R}
\include{Chapters/6_CaseStudy}
\include{Chapters/8_Webportal}
%\part{Conclusion}
