...
\hline
Извод & От самата база данни от чрез онтологията или посредством SPARQL. С общо предназначение, по-бавен. & Външен за базата данни. Трябва да се напише за всяка конкретна задача. Със специално предназначение. По-бърз. \\
\hline
...
\centering
\adjustbox{max width=\textwidth}{\includegraphics[width=\textwidth]{Figures/journal-selection}
\decoRule
...
\centering
\adjustbox{max width=\textwidth}{\includegraphics[width=\textwidth]{Figures/user-interface}
\decoRule
